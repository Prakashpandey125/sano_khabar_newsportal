...
from .models import (Category, StandardNews, MainNews, LatestNews, YoutubeLink, NewsComment)
...
def index(request):
    ...
    print("main_news", main_news_query)
    ...
    context = {'category_query': category_query, 'title': 'होमपेज', 'date': today_date,
               ...
               'section_3': section_3, 'section3_name': section3_name,
...
def per_page(request, ids):
    ...
    try:
        ...
        context = {'standard_news_query': standard_news_query, 'title': 'होमपेज', 'category_query': category_query,
                   ...
                   'youtube_link_query': youtube_link_query, 'news_query': news_query}
...
def post_comment(request, ids):
    ...
    if form.is_valid():
        ...
        news_comment = NewsComment(user_name=user_name, comment=comment, email=email, ids=news_id)
        news_comment.save()
